...
public class DummyPlayer implements Player {
    ...
    public DummyPlayer(int level, float exp){
        this.level = level;
        this.exp = exp;
    }
    ...
    @Override
    public BanEntry<PlayerProfile> ban(String reason, Instant expires, String source, boolean kickPlayer) {
        return null;
    }
    ...
    @Override
    public BanEntry<InetAddress> banIp(String reason, Instant expires, String source, boolean kickPlayer) {
        return null;
    }
